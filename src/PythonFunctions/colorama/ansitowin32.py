...
from src.PythonFunctions.colorama.ansi import BEL, AnsiBack, AnsiFore, AnsiStyle, Style
from src.PythonFunctions.colorama.win32 import winapi_test, windll
from src.PythonFunctions.colorama.winterm import WinColor, WinStyle, WinTerm
