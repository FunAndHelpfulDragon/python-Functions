...
def MultiBoardDisplay(*boards: typing.List[typing.List[str]],
                      colourData: typing.DefaultDict = None) -> str:
    ...
    Args:
        *boards (List[List[str]]): Variable-length list of 2D boards
        colourData (DefaultDict, optional): Dictionary that maps symbol names to terminal
        ...
        for row in boards:
            ...
            for board in row[col_group:col_group+max_cols]:
                ...
                for j, row in enumerate(board):
                    # Color the symbols in the row according to the colourData
                    colored_row = [colourData.get(
