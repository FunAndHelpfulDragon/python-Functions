...
class Message:
    ...
    @staticmethod
    def __messageSort(*, timeS:int=0, message:str=None, clear:bool=False, colour:typing.List=[None, None], delete:bool=False):
    ...
    @staticmethod
    def clear(message:str="", *, timeS:int=0, colour:typing.List=[None, None], delete:bool=False):
        ...
        """
        Message.__messageSort(timeS=timeS, message=message, colour=colour, clear=True, delete=delete)
    
    @staticmethod
    def warn(message: str=None, *, timeS: int=0, colour: typing.List=[None, None]):
